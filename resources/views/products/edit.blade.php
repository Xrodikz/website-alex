...
<div class="card">
    <div class="card-body">
        ...
        <form action="{{ route('products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                <label for="price" class="form-label">Add Price <span class="text-danger">*</span></label>
                <input value="{{$product->price}}" id="price" price="price" type="text" class="form-control" placeholder="Add Price">
            </div>
            <div class="mb-3">
